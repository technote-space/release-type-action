...
const execute = (logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    if (!(0, misc_1.isTargetBranch)(context)) {
        logger.info('This is not target branch.');
        return;
    }
    yield (0, pulls_1.setTitle)(logger, new api_helper_1.default(octokit, context, logger), octokit, context);
    yield (0, pulls_1.setLabels)(logger, octokit, context);
});
